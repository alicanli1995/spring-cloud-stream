...
public class RecordBuilder {
    ...
    public com.example.exact.model.Notification getNotification(com.example.exact.model.PosInvoice invoice){
        com.example.exact.model.Notification notificationLast = new com.example.exact.model.Notification();
    ...
    public com.example.exact.model.PosInvoice getMaskedInvoice(com.example.exact.model.PosInvoice invoice){
    ...
    public List<com.example.exact.model.HadoopRecord> getHadoopRecords(com.example.exact.model.PosInvoice invoice){
        List<com.example.exact.model.HadoopRecord> records = new ArrayList<>();

        for (com.example.exact.model.LineItem i : invoice.getInvoiceLineItems()) {
            com.example.exact.model.HadoopRecord record = new com.example.exact.model.HadoopRecord();
